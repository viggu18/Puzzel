...
export default function Signup({navigation}) {
    ...
    password === confirmPassword ? handleSignUp():setErrorMessage("Password doesn't match");
    }
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity onPress={verifyPassword} style={styles.loginBtn} activeOpacity={0.7} disabled={buttonDisable} >
                <Text style={styles.notuser}>Signup</Text>
            </TouchableOpacity>
            
            <View style={styles.notuserBtn}>
            <TouchableOpacity activeOpacity={0.7} onPress={()=>(navigation.push('Login'))} >
